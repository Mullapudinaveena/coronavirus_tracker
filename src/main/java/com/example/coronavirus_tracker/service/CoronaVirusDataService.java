package com.example.coronavirus_tracker.service;
...
import com.example.coronavirus_tracker.model.LocationStats;
...
public class CoronaVirusDataService {
	...
	public void fetchVirusData() throws IOException, InterruptedException {
		...
		HttpRequest request = HttpRequest.newBuilder().uri(URI.create(CORONAVIRUS_DATA_URL)).build();
